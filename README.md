...
1、由微软 SampleIME 增强改装，五笔词库源于极点，拼音词库源于微软
2、支持64和32位 全应用 
3、支持五笔拼音混合输入
4、左Shift左Ctrl可切换输入模式
5、右Ctrl （长按）或 Ctrl+W 快速造词
6、支持横向纵向候选窗口，右Ctrl（短按）或右键菜单可切换，
7、支持工具栏、候选窗口颜色词条数设置
8、系统词库、用户词库、表情符号均 txt UTF-16LE 文件格式，用户可自行修改更新
